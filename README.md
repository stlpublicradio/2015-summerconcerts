...
**TKTK: Describe 2015-summerconcerts here.**
...
```
cd 2015-summerconcerts
mkvirtualenv 2015-summerconcerts
...
```
* * * * * ubuntu bash /home/ubuntu/apps/2015_summerconcerts/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|2015-summerconcerts|tweet|`location`||||
|2015-summerconcerts|facebook|`location`||||
|2015-summerconcerts|email|`location`||||
|2015-summerconcerts|new-comment||||
|2015-summerconcerts|open-share-discuss||||
|2015-summerconcerts|close-share-discuss||||
|2015-summerconcerts|summary-copied||||
|2015-summerconcerts|featured-tweet-action|`action`||``tweet_url``|
|2015-summerconcerts|featured-facebook-action|`action`||``post_url``|
